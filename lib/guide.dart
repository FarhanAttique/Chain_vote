        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              '2. Select Vote Type.',
              style: TextStyle(fontSize: 16),
              textDirection: TextDirection.ltr, // English - Left
            ),
            Text(
              '3. Chose the PP and NA according to your Aera  .',
              style: TextStyle(fontSize: 16),
              textDirection: TextDirection.ltr, // English - Left
            ),
            Text(
            ...
            Text(
              '7. Chose Candidates in the given list .',
              style: TextStyle(fontSize: 16),
              textDirection: TextDirection.ltr, // English - Left
            ),
            Text(
            ...
            Text(
              ':ووٹ دینے کا طریقہ',
              style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
              textDirection: TextDirection.rtl, // Urdu - Right
            ),
            SizedBox(height: 10),
            Text(
